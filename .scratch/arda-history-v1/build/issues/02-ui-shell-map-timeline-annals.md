...
- [x] `QGraphicsView`/`QGraphicsScene` renders the map as the canvas with pan and zoom. — `ui/map_view.py` (the DF-style tile map per ADR-0001, in place of the reference map).
